...
[dr,mc,mcp,pdyn,cinf,vG]=rE.loadconnect(pathdir='../',mcinif='mcini_weierbach_x3',experimental=True)
mc = mcp.mcpick_out(mc,'weierbach_x3.pickle')

runname='weierbach_x3'
...
wdir='/work/kit/iwg/oj4748/weierbach'
try:
    #unpickle:
